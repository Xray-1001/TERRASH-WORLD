...
const DUNGEONS = [
  { id:1, name:"Hutan Pertama",          bg:"01_hutan_pertama.png",          element:"Bumi",   boss:"Raja Serigala Tunggul", monsterName:"Serigala Hutan" },
  { id:2, name:"Hutan Kedua",            bg:"02_hutan_kedua.png",            element:"Racun",  boss:"Ratu Lintah Rawa",      monsterName:"Siluman Rawa" },
  { id:3, name:"Hutan Ketiga",           bg:"03_hutan_ketiga.png",           element:"Gelap",  boss:"Penjaga Hutan Terkutuk",monsterName:"Mayat Berjalan" },
  { id:4, name:"Gua Api",                bg:"04_gua_api.png",                element:"Api",    boss:"Golem Kristal Purba",   monsterName:"Kelelawar Kristal" },
  { id:5, name:"Gua Es",                 bg:"05_gua_es.png",                 element:"Es",     boss:"Penjaga Reruntuhan",    monsterName:"Patung Hidup" },
  { id:6, name:"Gurun Kuno",             bg:"06_gurun_kuno.png",             element:"Waktu",  boss:"Naga Rawa Beracun",     monsterName:"Kalajengking Raksasa" },
  { id:7, name:"Benteng Bawah Tanah",    bg:"07_benteng_bawah_tanah.png",    element:"Baja",   boss:"Kesatria Baja Terkutuk",monsterName:"Prajurit Bayangan" },
  { id:8, name:"Hutan Keempat",          bg:"08_hutan_keempat.png",          element:"Racun",  boss:"Naga Es Abadi",         monsterName:"Serigala Es" },
  { id:9, name:"Reruntuhan Kuno",        bg:"09_reruntuhan_kuno.png",        element:"Waktu",  boss:"Iblis Penjaga Jurang",  monsterName:"Iblis Kecil" },
  { id:10,name:"Hutan Kelima",           bg:"10_hutan_kelima.png",           element:"Gelap",  boss:"Penguasa Kegelapan", monsterName:null, finalBoss:true },
];
...
function exitDungeonOneLevel(){
  const now=Date.now(); if(now-lastExit<3000) return; lastExit=now; // jeda ~3 detik sebelum bisa trigger keluar dungeon lagi
